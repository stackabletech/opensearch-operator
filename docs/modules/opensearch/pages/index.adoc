...
:crd: {crd-ref}{crd-ref-release}&operator=opensearch-operator
:crd-opensearchcluster: {crd-ref}/opensearch.stackable.tech/v1alpha1/opensearchcluster{crd-ref-release}
