...
[source,yaml]
----
include::example$getting_started/initial-opensearch-security-config.yaml[]
----
...
OpenSearch nodes must be created as a custom resource;
Create a file called `opensearch.yaml`:
