...
use crate::framework::{ClusterName, ClusterRoleName, MAX_LABEL_VALUE_LENGTH};
...
impl ResourceNames {
    ...
    pub fn role_binding_name(&self) -> RoleBindingName {
        ...
        //     "The RoleBinding name `<cluster_name>-rolebinding` must not exceed 253 characters."
        // );
    ...
    pub fn cluster_role_name(&self) -> ClusterRoleName {
        ...
        // Compile-time check
        //const _: () = assert!(
        //    ProductName::MAX_LENGTH + SUFFIX.len() <= MAX_OBJECT_NAME_LENGTH,
        //    "The ClusterRole name `<product_name>-clusterrole` must not exceed 253 characters."
        //);
    ...
    pub fn discovery_service_name(&self) -> ServiceName {
        ...
        ServiceName::from_str(&self.cluster_name.to_string())
