...
use crate::framework::{HasName, HasUid, NameIsValidLabelValue};
...
pub fn ownerreference_from_resource(
    resource: &(impl Resource<DynamicType = ()> + HasName + NameIsValidLabelValue + HasUid),
...
mod tests {
    ...
    use crate::framework::{
        HasName, HasUid, NameIsValidLabelValue, Uid, builder::meta::ownerreference_from_resource,
    };
