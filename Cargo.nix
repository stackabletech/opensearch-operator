    ...
    crates = {
      ...
      "k8s-version" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "f3a0923138059bfdfe1bb7115341c85187167e86";
          sha256 = "0kg50f12jzp6d0aa36i3kd3r3whw62znkkf5l0gm0d18gmf4kg1x";
        };
        libName = "k8s_version";
        authors = [
      ...
      "tonic-types" = rec {
        ...
        version = "0.14.5";
        edition = "2021";
        sha256 = "16bk1cxi2m0xgaabf98nnj7dn9j16ymkh27jq4s3shjm4a85m1ra";
        libName = "tonic_types";
        authors = [
          "Lucio Franco <luciofranco14@gmail.com>"
