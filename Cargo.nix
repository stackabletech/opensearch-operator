...
rec {
  ...
  rootCrate = rec {
    packageId = "stackable-opensearch-operator";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "cc" = rec {
        ...
        version = "1.2.26";
        edition = "2018";
        sha256 = "1b5g9ln7a2imwhrvfi77qbmj7gxsg0xihrlvarrg71wbk0hmwslm";
        authors = [
      ...
      "syn 2.0.102" = rec {
        ...
        version = "2.0.102";
        edition = "2021";
        sha256 = "0qh4v2nj61y82cc713fakjckhmwyvllq9n0gpmcg147sjjppsfgn";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
      ...
      "tracing-attributes" = rec {
        ...
        version = "0.1.29";
        edition = "2018";
        sha256 = "0qpn22v675pbgmrkjsx3abj6lr5s12v4wi77hv9rjsvgkk7zn7qv";
        procMacro = true;
