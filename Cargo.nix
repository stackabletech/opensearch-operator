    ...
    crates = {
      ...
      "k8s-version" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "b018f1dce2c373fdc85d0099b0c823e3c1077b36";
          sha256 = "02i3s1ziy7km32z3xi7g97p3rw4v8z5ykq0ighmja00b3n363v3v";
        };
        libName = "k8s_version";
        authors = [
      ...
      "schemars 1.0.4" = rec {
        ...
        dependencies = [
          ...
          {
            name = "schemars_derive";
            packageId = "schemars_derive 1.0.4";
            optional = true;
          }
          {
            name = "serde";
