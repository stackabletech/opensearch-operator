...
Expand the name of the chart.
*/}}
{{- define "opensearch-operator.appname" -}}
...
app.kubernetes.io/name: {{ include "opensearch-operator.appname" . }}
...
{{- default (printf "%s-serviceaccount" (include "opensearch-operator.fullname" .)) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "opensearch-operator.testLabels" -}}
helm.sh/test: {{ include "opensearch-operator.chart" . }}
{{- end }}

{{/*
Build the full operator container image reference.
*/}}
{{- define "opensearch-operator.image" -}}
